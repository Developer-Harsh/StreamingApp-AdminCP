                    ...
                    <div class="card">
                        <div class="stat-widget-one card-body">
                            ...
                            <div class="stat-content d-inline-block">
                                ...
                                <div class="stat-digit">11700</div>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-lg-3 col-md-3 col-sm-3 col-xs-3 col-3">
                                    <div class="form-group">
                                        <button type="button" name="search" id="search" class="btn btn-primary" style="margin-top: 27px;">Search</button>
                                        <button type="button" name="clear" id="clear" class="btn btn-danger" style="margin-top: 27px;">Clear</button>
                                    </div>
                                </div>
                            </div>
...
$sql = "SELECT * FROM points_information";
$result = mysqli_query($conn, $sql);

if (!$result) {
    echo "Error: " . mysqli_error($conn);
} else {
    echo '<table class="table student-data-table m-t-20">
            <thead>
                <tr>
                    <th>S.no</th>
                    <th>Date</th>
    ...
    while ($row = mysqli_fetch_assoc($result)) {
        ...
        echo '<td>' . $row['S_no'] . '</td>';
        echo '<td>' . $row['Date'] . '</td>';
        echo '<td>' . $row['Charged_Point'] . '</td>';
        echo '<td>' . $row['Used_Point'] . '</td>';
        echo '<td>' . $row['Invitor_Point'] . '</td>';
        echo '<td>' . $row['Redeem_Point'] . '</td>';
        echo '</tr>';
    }
