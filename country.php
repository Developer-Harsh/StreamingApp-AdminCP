                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <div id="example_wrapper" class="dataTables_wrapper no-footer"><div class="dataTables_length" id="example_length"><label>Show <select name="example_length" aria-controls="example" class=""><option value="10">10</option><option value="25">25</option><option value="50">50</option><option value="100">100</option></select> entries</label></div><div id="example_filter" class="dataTables_filter"><label>Search:<input type="search" class="" placeholder="" aria-controls="example"></label></div><table id="example" class="table table-striped table-bordered dataTable no-footer" style="width: 100%;" role="grid" aria-describedby="example_info">
                                <thead>
                                    <tr role="row"><th class="sorting sorting_asc" tabindex="0" aria-controls="example" rowspan="1" colspan="1" aria-sort="ascending" aria-label="Flag: activate to sort column descending" style="width: 146.333px;">Flag</th><th class="sorting" tabindex="0" aria-controls="example" rowspan="1" colspan="1" aria-label="Name: activate to sort column ascending" style="width: 145.333px;">Name</th><th class="sorting" tabindex="0" aria-controls="example" rowspan="1" colspan="1" aria-label="Created At: activate to sort column ascending" style="width: 164.333px;">Created At</th><th class="sorting" tabindex="0" aria-controls="example" rowspan="1" colspan="1" aria-label="Updated At: activate to sort column ascending" style="width: 164.333px;">Updated At</th><th class="sorting" tabindex="0" aria-controls="example" rowspan="1" colspan="1" aria-label="Action: activate to sort column ascending" style="width: 100.333px;">Action</th></tr>
                                </thead>
                                <tbody>
                                ...
                                <tr class="odd">
                                                <td class="sorting_1">kenya</td>
                                                <td><img src="http://127.0.0.1:8000/country_images/20220117160908.PNG" style="width: 60px;height: 60px;object-fit: cover;">
                                                </td>
                                                <td>17-01-2022</td>
                                                <td>17-01-2022</td>
                                                <td>
                                                    <span class="ti-slice" onclick="edit(6)"></span>
                                                    <span class="ti-trash" onclick="deletes(6)"></span>
                                                </td>

                                            </tr><tr class="even">
                                                <td class="sorting_1">pakistans</td>
                                                <td><img src="http://127.0.0.1:8000/country_images/20220115135141.png" style="width: 60px;height: 60px;object-fit: cover;">
                                                </td>
                                                <td>15-01-2022</td>
                                                <td>15-01-2022</td>
                                                <td>
