                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <div id="example_wrapper" class="dataTables_wrapper no-footer"><div class="dataTables_length" id="example_length"><label>Show <select name="example_length" aria-controls="example" class=""><option value="10">10</option><option value="25">25</option><option value="50">50</option><option value="100">100</option></select> entries</label></div><div id="example_filter" class="dataTables_filter"><label>Search:<input type="search" class="" placeholder="" aria-controls="example"></label></div><table id="example" class="table table-striped table-bordered dataTable no-footer" style="width:100%" role="grid" aria-describedby="example_info">
                                <thead>
                                    <tr role="row"><th class="sorting sorting_asc" tabindex="0" aria-controls="example" rowspan="1" colspan="1" aria-sort="ascending" aria-label="Title: activate to sort column descending" style="width: 140.5px;">Title</th><th class="sorting" tabindex="0" aria-controls="example" rowspan="1" colspan="1" aria-label="Intersitial ID: activate to sort column ascending" style="width: 158.062px;">Intersitial ID</th><th class="sorting" tabindex="0" aria-controls="example" rowspan="1" colspan="1" aria-label="Reward ID: activate to sort column ascending" style="width: 173.791px;">Reward ID</th><th class="sorting" tabindex="0" aria-controls="example" rowspan="1" colspan="1" aria-label="Native ID: activate to sort column ascending" style="width: 165.916px;">Native ID</th><th class="sorting" tabindex="0" aria-controls="example" rowspan="1" colspan="1" aria-label="Action: activate to sort column ascending" style="width: 77.7293px;">Action</th></tr>
                                </thead>
                                <tbody>
                                                ...
                                                <td>
                                                    ca-app-pub-654654654651124
                                                </td>
                                                <td>
                                                    ojosdfkjsdfsd
                                                </td>
                                                <td>
                                                    ca-app-pub-7898510200333645
                                                </td>
                                                <td>
                                                    <label class="switch">
                                                        <input type="checkbox" name="ad_2" id="ad_2" value="2" checked="">
                                                        <span class="slider round"></span>
                                                    </label>
                                                    <span class="ti-slice" onclick="edit(2)"></span>
                                                </td>
                                            </tr><tr class="even">
                                                <td class="sorting_1">
                                                    Google Ad Revenue
                                                ...
                                                <td>
                                                    ca-app-pub-654654654651155
                                                </td>
                                                <td>
                                                    ca-app-pub-63245478787798799
                                                </td>
                                                <td>
                                                    ca-app-pub-7898510200333688
                                                </td>
                                                <td>
                                                    <label class="switch">
                                                        <input type="checkbox" name="ad_1" id="ad_1" value="1" checked="">
                                                        <span class="slider round"></span>
                                                    </label>
                                                    <span class="ti-slice" onclick="edit(1)"></span>
                                                </td>
                                            </tr></tbody>
