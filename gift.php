...
<table id="example" class="table table-striped table-bordered dataTable no-footer" style="width:100%" role="grid" aria-describedby="example_info">
    <thead>
        <tr role="row">
            <th class="sorting sorting_asc" tabindex="0" aria-controls="example" rowspan="1" colspan="1" aria-sort="ascending" aria-label="Gift: activate to sort column descending" style="width: 118.416px;">Gift</th>
            <th class="sorting" tabindex="0" aria-controls="example" rowspan="1" colspan="1" aria-label="Coin: activate to sort column ascending" style="width: 56px;">Coin</th>
            <th class="sorting" tabindex="0" aria-controls="example" rowspan="1" colspan="1" aria-label="Category Name: activate to sort column ascending" style="width: 166.208px;">Category Name</th>
            <th class="sorting" tabindex="0" aria-controls="example" rowspan="1" colspan="1" aria-label="Created At: activate to sort column ascending" style="width: 134.25px;">Created At</th>
            <th class="sorting" tabindex="0" aria-controls="example" rowspan="1" colspan="1" aria-label="Updated At: activate to sort column ascending" style="width: 134.25px;">Updated At</th>
            <th class="sorting" tabindex="0" aria-controls="example" rowspan="1" colspan="1" aria-label="Action: activate to sort column ascending" style="width: 80.2083px;">Action</th>
        </tr>
    </thead>
    <tbody>
        <?php
        ...
        while ($row = mysqli_fetch_assoc($result)) {
            echo '<tr class="odd">';
            echo '<td class="sorting_1"><img src="' . $MEDIA_DOMAIN . $row['GIFT'] . '" style="width: 60px;height: 60px;object-fit: cover;"></td>';
            echo '<td>' . $row['COIN'] . '</td>';
        ...
        ***********************************-->
        ...
        <div class="modal fade" id="newModal">
                        ...
                        <div class="form-group">
                            <label for="recipient-name" class="col-form-label">Gift Name:</label>
                            <input type="text" name="country" id="new_country" class="form-control" required="">
                        </div>
                        <div class="form-group">
                            <label for="recipient-name" class="col-form-label">Gift Coins:</label>
                            <input type="text" name="country" id="new_coins" class="form-control" required="">
                        </div>
                        <div class="form-group">
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function() {
            $("#submit").click(function(e) {
                ...
                let coins = $("#new_coins").val(); // Use val() to get the input value

                if (img.length > 0) {
                    form_data.append('my_image', img[0]);
                    form_data.append('flag', flag);
                    form_data.append('coins', coins);

                    $.ajax({
                        url: 'process_gift.php',
                        type: 'post',
                        data: form_data,
                        contentType: false,
                        processData: false,
