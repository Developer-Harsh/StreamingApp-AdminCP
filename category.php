...
<div class="col-lg-12">
    ...
    <thead>
        <tr role="row">
            <th class="sorting sorting_asc" tabindex="0" aria-controls="example" rowspan="1" colspan="1" aria-sort="ascending" aria-label="Image: activate to sort column descending" style="width: 71.3333px;">Image</th>
            <th class="sorting" tabindex="0" aria-controls="example" rowspan="1" colspan="1" aria-label="Name: activate to sort column ascending" style="width: 48.3333px;">Name</th>
            <th class="sorting" tabindex="0" aria-controls="example" rowspan="1" colspan="1" aria-label="Created At: activate to sort column ascending" style="width: 55.3333px;">Created At</th>
            <th class="sorting" tabindex="0" aria-controls="example" rowspan="1" colspan="1" aria-label="Updated At: activate to sort column ascending" style="width: 56.3333px;">Updated At</th>
            <th class="sorting" tabindex="0" aria-controls="example" rowspan="1" colspan="1" aria-label="Is Top: activate to sort column ascending" style="width: 71.3333px;">Is Top</th>
            <th class="sorting" tabindex="0" aria-controls="example" rowspan="1" colspan="1" aria-label="Action: activate to sort column ascending" style="width: 45.3333px;">Action</th>
        </tr>
    </thead>
    <tbody>
        <?php
...
if (!$result) {
    die("Query failed: " . mysqli_error($conn));
        ...
        // Assuming you have fetched data from your database into $result
        while ($row = mysqli_fetch_assoc($result)) {
            echo '<tr class="odd">';
            echo '<td class="sorting_1"><img src="' . $MEDIA_DOMAIN . $row['IMAGE'] . '" style="width: 60px;height: 60px;object-fit: cover;"></td>';
            echo '<td>' . $row['NAME'] . '</td>';
            echo '<td>' . $row['CREATED_AT'] . '</td>';
            echo '<td>' . $row['UPDATED_AT'] . '</td>';
            echo '<td>';
            echo '<label class="switch">';
            echo '<input type="checkbox" name="category_' . $row['ID'] . '" id="category_' . $row['ID'] . '" value="' . $row['ID'] . '"';
            echo ($row['IS_TOP'] == 1) ? ' checked' : '';
            echo '>';
