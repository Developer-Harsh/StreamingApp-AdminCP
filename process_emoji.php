<?php
if (isset($_FILES['my_image']) && isset($_POST['flag']) && isset($_POST['coins'])) {
    $sname = "localhost";
    $uname = "harsh";
    $password = "harsh";
    $db_name = "tango";
        ...
        if ($img_size > 1000000) {
            ...
            if (in_array($img_ex_lc, $allowed_exs)) {
                ...
                if (move_uploaded_file($tmp_name, $img_upload_path)) {
                    ...
                    $COINS = mysqli_real_escape_string($conn, $COINS);
                    ...
                    $sql = "INSERT INTO gifts (GIFT, COIN, CATEGORY_NAME, CREATED_AT, UPDATED_AT) VALUES ('$new_img_name', $COINS, '$FLAG', '$current_time', '$current_time')";
