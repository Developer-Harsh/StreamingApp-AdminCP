                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <div id="example_wrapper" class="dataTables_wrapper no-footer"><div class="dataTables_length" id="example_length"><label>Show <select name="example_length" aria-controls="example" class=""><option value="10">10</option><option value="25">25</option><option value="50">50</option><option value="100">100</option></select> entries</label></div><div id="example_filter" class="dataTables_filter"><label>Search:<input type="search" class="" placeholder="" aria-controls="example"></label></div><table id="example" class="table table-striped table-bordered dataTable no-footer" style="width:100%" role="grid" aria-describedby="example_info">
                                <thead>
                                    <tr role="row"><th class="sorting sorting_asc" tabindex="0" aria-controls="example" rowspan="1" colspan="1" aria-sort="ascending" aria-label="Username: activate to sort column descending" style="width: 230.041px;">Username</th><th class="sorting" tabindex="0" aria-controls="example" rowspan="1" colspan="1" aria-label="Password: activate to sort column ascending" style="width: 123.021px;">Password</th><th class="sorting" tabindex="0" aria-controls="example" rowspan="1" colspan="1" aria-label="Role: activate to sort column ascending" style="width: 125.291px;">Role</th><th class="sorting" tabindex="0" aria-controls="example" rowspan="1" colspan="1" aria-label="Created At: activate to sort column ascending" style="width: 134.583px;">Created At</th><th class="sorting" tabindex="0" aria-controls="example" rowspan="1" colspan="1" aria-label="Action: activate to sort column ascending" style="width: 80.3953px;">Action</th></tr>
                                </thead>
                                <tbody>
                                ...
                                <tr class="odd">
                                                ...
                                                <td>10-01-2022</td>
                                                <td>
                                                    <span class="ti-slice" onclick="edit(5)"></span>
                                                    <span class="ti-trash" onclick="deletes(5)"></span>
                                                </td>
                                                ...
                                                <td>15-01-2022</td>
                                                <td>
                                                    <span class="ti-slice" onclick="edit(13)"></span>
                                                    <span class="ti-trash" onclick="deletes(13)"></span>
                                                </td>
                                                ...
                                                <td>01-01-1970</td>
                                                <td>
                                                    <span class="ti-slice" onclick="edit(9)"></span>
                                                    <span class="ti-trash" onclick="deletes(9)"></span>
                                                </td>
                                                ...
                                                <td>18-02-2022</td>
                                                <td>
                                                    <span class="ti-slice" onclick="edit(18)"></span>
                                                    <span class="ti-trash" onclick="deletes(18)"></span>
                                                </td>
                                                ...
                                                <td>18-02-2022</td>
                                                <td>
                                                    <span class="ti-slice" onclick="edit(20)"></span>
                                                    <span class="ti-trash" onclick="deletes(20)"></span>
                                                </td>
                                                ...
                                                <td>15-01-2022</td>
                                                <td>
                                                    <span class="ti-slice" onclick="edit(12)"></span>
                                                    <span class="ti-trash" onclick="deletes(12)"></span>
                                                </td>
                                                ...
                                                <td>11-01-2022</td>
                                                <td>
                                                    <span class="ti-slice" onclick="edit(10)"></span>
                                                    <span class="ti-trash" onclick="deletes(10)"></span>
                                                </td>
                                                ...
                                                <td>28-01-2022</td>
                                                <td>
                                                    <span class="ti-slice" onclick="edit(16)"></span>
                                                    <span class="ti-trash" onclick="deletes(16)"></span>
                                                </td>
                                                ...
                                                <td>18-02-2022</td>
                                                <td>
                                                    <span class="ti-slice" onclick="edit(19)"></span>
                                                    <span class="ti-trash" onclick="deletes(19)"></span>
                                                </td>
                                                ...
                                                <td>30-01-2022</td>
                                                <td>
                                                    <span class="ti-slice" onclick="edit(17)"></span>
                                                    <span class="ti-trash" onclick="deletes(17)"></span>
                                                </td>

                                            </tr></tbody>

                            </table><div class="dataTables_info" id="example_info" role="status" aria-live="polite">Showing 1 to 10 of 10 entries</div><div class="dataTables_paginate paging_simple_numbers" id="example_paginate"><a class="paginate_button previous disabled" aria-controls="example" data-dt-idx="0" tabindex="-1" id="example_previous">Previous</a><span><a class="paginate_button current" aria-controls="example" data-dt-idx="1" tabindex="0">1</a></span><a class="paginate_button next disabled" aria-controls="example" data-dt-idx="2" tabindex="-1" id="example_next">Next</a></div></div>
                        </div>
                    </div>
                </div>
