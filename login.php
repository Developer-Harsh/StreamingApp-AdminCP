...
<body class="h-100">
                        ...
                        <div class="row no-gutters">
                            <div class="col-xl-12">
                                <div class="auth-form">
                                    ...
                                    <form id="formLogin" action="./api/loginApi.php" method="POST" onsubmit="return validation()">
    ...
    ***********************************-->
    ...
    <script>  
            function validation()  
            {  
                var id=document.formLogin.email.value;  
                var ps=document.formLogin.password.value;  
